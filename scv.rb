HOMEBREW_SCV_VERSION="1.0.0"

class Scv < Formula
  desc "similarities and distances calculator among vectors."
  homepage "https://github.com/tamada/scv"
  url "https://github.com/tamada/scv/releases/download/v#{HOMEBREW_SCV_VERSION}/scv-#{HOMEBREW_SCV_VERSION}_darwin_amd64.tar.gz"
  version HOMEBREW_SCV_VERSION
